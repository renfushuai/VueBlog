<template>
    <section>
        ...
        style="width: 100%;">
            ...
            <!-- <el-table-column prop="PnameArr" label="父节点" width="" >
            </el-table-column> -->
            <el-table-column prop="Code" label="路由地址" width="" >
            </el-table-column>
            <el-table-column prop="MName" label="API接口" width="" >
            </el-table-column>
            <el-table-column prop="CreateTime" label="创建时间" :formatter="formatCreateTime" width="150" >
            </el-table-column>
            ...
            <el-table-column prop="OrderSort" label="排序" width="" >
            </el-table-column>
            <el-table-column prop="IsButton" label="按钮" width="100" >
                <template slot-scope="scope">
                    <el-tag
            ...
            <el-table-column prop="Func" label="按钮事件" width="" >
            </el-table-column>
            <el-table-column prop="IsHide" label="隐藏" width="100" >
                <template slot-scope="scope">
                    <el-tag
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item prop="IsButton" label="是否按钮" width="" >
                ...
                <el-form-item prop="PidArr" label="父级菜单" width="" >
                ...
                <el-form-item prop="Mid" label="API接口" width="" >
